...
export default function Gallery({ data, orientation }) {
    ...
    const galleryHorizontalStyles = {
        container: {
            ...
            innerContainer: {
                display: 'flex', width: '100%', flexDirection: 'row', margin: '20px', borderRadius: '10px', padding: '0%', overflow: 'hidden', maxHeight: '65vh'
            },
        },
        smallImagesContainer: { display: 'flex', flexFlow: "column nowrap", flex: 1, marginLeft: '10px', maxHeight: '100%', overflow: 'scroll', justifyContent: 'space-between' },
        largeImage: { flex: 2.5, },
    ...
    const galleryVerticalStyles = {
        container: {
            ...
            innerContainer: {
                display: 'flex', width: '100%', borderRadius: '10px', flexDirection: 'column', padding: '0%', overflow: 'scroll',
            },
        },
        smallImagesContainer: { display: 'flex', flexFlow: "row wrap", justifyContent: 'space-between', marginTop: '10px' },
        largeImage: {},
    ...
    return (
        <div style={galleryStyles.container}>
            ...
            <Modal
                ...
                content={<ModalGalleryViewer data={data} galleryIndex={galleryIndex} setGalleryIndex={setGalleryIndex} />}
...
export function ModalGalleryViewer({ data, galleryIndex, setGalleryIndex }) {
    ...
    const modalGalleryViewerStyles = {
        ...
        photographContainer: { display: 'flex', flexDirection: 'row', minWidth: '100%', height: '70vh' },
        photograph: { borderRadius: '10px', margin: '10px', minWidth: '1000px', height: '70vh', },
    }
