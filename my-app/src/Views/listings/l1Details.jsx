 ...
 * @function L1Details 
 * 
 * @brief (Child component of a component found in Post.js) Renders the L1Details component, which displays information about the highest level of a property listing (building).
 * 
 * @details
...
export default function L1Details() {
    ...
    const pageStyles = {
        ...
        body: {
            ...
            leftSide: { margin: '10px', padding: '10px', width: '55%', display: 'flex', alignItems: 'flex-start', flexDirection: 'column', },
            rightSide: { width: '45%', display: 'flex', alignItems: 'flex-end', flexDirection: 'column', padding: '20px 0px 20px 0px' }
        }
    }
