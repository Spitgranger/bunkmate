                    ...
                    <div className="profile-info" style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                        <header style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', }}>
                            <div style={{ width: '100%', display: 'flex', flexDirection: 'column', padding: '5px' }}>
                                ...
                                <CardContent style={{ top: '216px', backgroundColor: 'black', opacity: '0.9', position: 'absolute', width: '330px', padding: '15px 15px 15px 15px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                            ...
                            <Typography style={{ padding: '10px', whiteSpace: 'pre-line', overflowY: 'scroll', width: '100%', maxHeight: '100px', textOverflow: 'elipsis' }} variant="body1" color="text.secondary">
                                {profile.bio}
                            </Typography>
                        </header >
                    </div >
