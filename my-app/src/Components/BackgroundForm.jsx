...
function Background({ forwardButton }) {
  ...
  return (<>
    ...
    <LineBox flex={true} CssTextField={[
      <FormSingleLineInput size="small" type="text" field="Email" placeHolder="ex. bunkmates@gmail.com" error={emailError} helperText={emailHelperText} value={values.email} onChange={(e) => { handleFieldChange(e, 'email'); handleEmailValidation(e); }} />,
      <DatePicker label="Birthday" onChange={handleChange} value={value} />
    ]
    } />
    <LineBox flex={true} CssTextField={[
      <FormSingleLineInput type="text" size="small" helperText={phoneHelperText} field="Phone Number" placeHolder="6472345124" error={phoneError} onChange={(e) => { handleFieldChange(e, 'phone'); handlePhoneValidation(e); }} value={values.phone} />,
