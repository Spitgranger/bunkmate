...
import {setUnitIndex, setBunkmateCount, setPetCount} from '../../../../features/applications/applicationsSlice.js';
 ...
 */
export default function UnitInfoCard(data: object, index: number): Element {
 ...
 */
function UnitInfo(data: object, index: number) {
                ...
                <CardContent sx={unitInfoStyles.topSide.rightSide.container}>
                    <div style={unitInfoStyles.topSide.rightSide.unitInfoContainer}>
                        <Typography variant={"h5"} color={'text.primary'}
                                    sx={unitInfoStyles.unitNumber}>{unitData.title}</Typography>
                        <Typography variant={"h5"} color={'text.secondary'}
                                    sx={unitInfoStyles.unitPrice}>{`$${unitData.price}`}</Typography>
                        <Typography variant={"h6"} color={'text.secondary'}
                                    sx={unitInfoStyles.unitType}>{unitData.type}</Typography>
                    </div>
                </CardContent>
            </div>
